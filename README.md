...
| 书名  |类型   | 封面                   |
| ----------|----- | --------- |
| 深度学习入门：基于Python的理论与实现 | 代码 | <img width = '150' height ='200' src ="./assets/image-20240301085520701.png"/> |
| SQL必知必会（第五版）         |  代码     | <img width = '150' height ='200' src ="./assets/image-20240301085448284.png"/> |
